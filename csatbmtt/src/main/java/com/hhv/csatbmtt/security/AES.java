...
public class AES {
	...
	private void InvMixColumns() {
		...
		for (int i = 0; i < 4; i++) {
			...
			state[0][i] = (byte) (Multiply(a, (byte) 0x0e) ^ Multiply(b, (byte) 0x0b) ^ Multiply(c, (byte) 0x0d)
					^ Multiply(d, (byte) 0x09));
			state[1][i] = (byte) (Multiply(a, (byte) 0x09) ^ Multiply(b, (byte) 0x0e) ^ Multiply(c, (byte) 0x0b)
					^ Multiply(d, (byte) 0x0d));
			state[2][i] = (byte) (Multiply(a, (byte) 0x0d) ^ Multiply(b, (byte) 0x09) ^ Multiply(c, (byte) 0x0e)
					^ Multiply(d, (byte) 0x0b));
			state[3][i] = (byte) (Multiply(a, (byte) 0x0b) ^ Multiply(b, (byte) 0x0d) ^ Multiply(c, (byte) 0x09)
